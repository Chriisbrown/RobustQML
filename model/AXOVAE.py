...
@ADModelFactory.register('AXOVAE')
class AXOVAE(ADModel):

    """AXOVAE class

    Args:
        AXOVAE (_type_): Base class of a AutoEncoderModel
    """
    ...
    def build_model(self, inputs_shape: tuple):
        ...
        self.AD_model = VariationalAutoEncoder( inputs_shape, latent_dim)
